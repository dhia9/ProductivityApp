...
export default function PopupErrorMassage({ user }: { user: string }) {
    return (<Typography variant="h6" color="error" align="center" sx={{ mt: 2,color:"red", maxWidth: '50%', marginLeft: '25%', border: '1px solid black', borderRadius: '0.375rem', padding: 0 }}>
